import { Box, Button, Card, Drawer, Grid, IconButton, styled, useMediaQuery, useTheme } from "@mui/material";
import FlexBox from "../../../components/flexbox/FlexBox";
import { H5 } from "../../../components/Typography";
import Apps from "../../../assets/icons/Apps";
import Icons from "../../../assets/icons/account";
import TabComponent from "../../../account" ;
...
const Account = () => {
  ...
  function TabListContent() {
    return <FlexBox flexDirection="column">
        ...
        name,
        Icon
      }) => <StyledButton key={id} onClick={() => {
        setActive(name);
        setOpenDrawer(false);
      }} startIcon={<Icon sx={{
        color: "text.secondary"
      }} />} sx={active === name ? style : {
        "&:hover": style
      }}>
            {t(name)}
          </StyledButton>)}
